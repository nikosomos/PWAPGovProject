...
public class UploadReceiverRS extends HttpServlet
{
    private static final File UPLOAD_DIR = new File("////M:/AEMA/DRP PSPD/PC/PWAP/Portal Attachments/Complete Reports/");
    private static File TEMP_DIR = new File("////M:/AEMA/DRP PSPD/PC/PWAP/Portal Attachments/tmp/");

    private static String CONTENT_LENGTH = "Content-Length";
    private static int SUCCESS_RESPONSE_CODE = 200;

    final Logger log = LoggerFactory.getLogger(UploadReceiverRS.class);
