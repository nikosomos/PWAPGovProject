...
public class UploadReceiverUR extends HttpServlet
{
    private static final File UPLOAD_DIR = new File("////M:/AEMA/DRP PSPD/PC/PWAP/Portal Attachments/Updates/");
    ...
    final Logger log = LoggerFactory.getLogger(UploadReceiverUR.class);
